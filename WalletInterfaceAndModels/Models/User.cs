...
namespace WalletSimulator.Interface.Models
{
    public class User
    {
        ...
        private const string PubblicKey =
                "<RSAKeyValue><Modulus>sr4l8EwMgPqPhRTK+dPTwGs9uYhDeUohSRL48ZDf85/5/Lo469WltKFaQvA2Msy92xq14YPPN6p6mQD7stVbinRd+hihnYoqfclYRMe+FG6jqu/QACl0N6JgwM7iKGiyzBjL1vkvcSoaqwbxD7QPHgrdNlkyP0z6Vz7j79PFEos=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>"
            ;
        ...
        private User()
        {
            UserWalletRelations = new List<UserWalletRelation>();
        }
